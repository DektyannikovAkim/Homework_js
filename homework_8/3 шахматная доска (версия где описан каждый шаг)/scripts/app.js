let app = {
    ...
    insertPawns() {
        ...
        //     whitePawnsRow[i].innerHTML = this.getFigure("pawn", "black");
        // }

        for (const whitePawnRow of whitePawnsRow) {
            whitePawnRow.innerHTML = this.getFigure("pawn", "black");
        }
        ...
        //     blackPawnsRow[i].innerHTML = this.getFigure("pawn", "white");
        // }

        for (const blackPawnRow of blackPawnsRow) {
            blackPawnRow.innerHTML = this.getFigure("pawn", "white");
        }
    ...
    generateBoard() {
        ...
        //     board += row;
        // }
        for (const rowItem of app.config.rows) {
            let row = "";
            if (rowStartWithColor == 'white') {
                row = this.generateRow(rowStartWithColor, rowItem);
                rowStartWithColor = "black";
            } else {
                row = this.generateRow(rowStartWithColor, rowItem);
                rowStartWithColor = "white";
    ...
    generateRow(startWithColor, rowNum) {
        ...
        for (const cols of app.config.cols) {
            field = "";
            if (currentColorClass == "white") {
                field = this.generateField(currentColorClass, rowNum, cols);
                currentColorClass = "black";
            } else {
                field = this.generateField(currentColorClass, rowNum, cols);
                currentColorClass = "white";
    ...
    insertColsChars() {
        ...
        for (const colsItem of this.config.cols) {
            tr.innerHTML += `<td>${colsItem}</td>`;
        }
